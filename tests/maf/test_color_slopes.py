...
class TestSimpleMetrics(unittest.TestCase):
    def test_color_slope(self):
        ...
        data["observationStartMJD"] = np.array([0, .25, .5, 0.55])/24
        data["filter"] = ["r", "r", "r", "r"]
        data["fiveSigmaDepth"] = 25.

        csm = metrics.ColorSlopeMetric(color_length=1.0,
                                       slope_length=3.0)

        cs2n = metrics.ColorSlope2NightMetric(color_length=1.0,
                                              slope_length=15.0)
        ...
        data["observationStartMJD"] = np.array([0, .25, .5, 3.55])/24
        data["filter"] = ["r", "g", "r", "r"]
        ...
        data["night"] = [0, 0, 0, 1]
        data["observationStartMJD"] = np.array([0, .25, .5, 25])/24
        data["filter"] = ["r", "g", "r", "r"]
        ...
        data["night"] = [0, 0, 0, 1]
        data["observationStartMJD"] = np.array([0, .25, 3.5, 25])/24
        data["filter"] = ["r", "g", "r", "r"]
